...
public class Axis extends Canvas implements Runnable, KeyListener, ActionListener, MouseListener, MouseMotionListener {
	Toolkit tk = Toolkit.getDefaultToolkit();
    public int WIDTH2 = ((int) tk.getScreenSize().getWidth());
    public int HEIGHT2 = ((int) tk.getScreenSize().getHeight());
    
    public int WIDTH = 732;
	...
	private void render() {
        ...
        for(int k = 0; k < main.lines.size(); k++) {
        ...
        for(int i = 0; i < fileArray.size(); i++) {
    		...
    		if(((Save)fileArray.get(i)).selected) {
    			...
    			g.fillRect(21, 41 + 20*off + offset, 8, 8);
    		}
    	}
